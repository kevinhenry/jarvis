...
setup (
 ...
 entry_points='''
    ...
    ''',
 author="Kevin Henry",
 keyword="sunglass, hut, scrape, csv",
 long_description=README,
 long_description_content_type="text/markdown",
 license='MIT',
 url='https://github.com/kevinhenry/jaris',
 download_url='https://github.com/kevinhenry/jarvis/archive/1.0.0.tar.gz',
  dependency_links=dependency_links,
  author_email='kevinhenry@live.com',
  classifiers=[
